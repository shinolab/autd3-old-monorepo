...
void AUTDSetMode(void* geometry_builder, uint8_t mode);
...
bool AUTDSend(void* handle, void* header, void* body, int64_t timeout_ns);
bool AUTDSendSpecial(void* handle, void* special, int64_t timeout_ns);
...
void AUTDSoftwareSTM(void** out, uint8_t strategy);
...
uint32_t AUTDSoftwareSTMSamplingPeriod(void* stm);
void AUTDSoftwareSTMSetSamplingPeriod(void* stm, uint32_t period);
void AUTDDeleteSoftwareSTM(void* stm);
void AUTDLinkDebug(void** out);
void AUTDLinkDebugLogLevel(void* debug, int32_t level);
void AUTDLinkDebugLogFunc(void* debug, void* out_func, void* flush_func);
void AUTDLinkDebugTimeout(void* debug, uint64_t timeout_ns);

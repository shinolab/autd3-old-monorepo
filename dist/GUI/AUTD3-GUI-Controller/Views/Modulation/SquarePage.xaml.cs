...
public sealed partial class SquarePage
{
    ...
    public SquarePage()
    {
        ViewModel = App.GetService<SquareViewModel>();
        InitializeComponent(); _localizer = App.GetService<ILocalizer>();

    }

    private void SquarePage_OnLoaded(object sender, RoutedEventArgs e)
    {

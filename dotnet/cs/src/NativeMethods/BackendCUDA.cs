...
namespace AUTD3Sharp
{
    internal static unsafe partial class NativeMethodsBackendCUDA
    {
        ...
        public static extern GainPtr AUTDGainHoloCUDAEVP(BackendPtr backend, double* points, double* amps, ulong size);
        ...
        public static extern GainPtr AUTDGainHoloCUDAEVPWithGamma(GainPtr holo, double gamma);

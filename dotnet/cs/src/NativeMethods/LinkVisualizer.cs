...
namespace AUTD3Sharp
{
    internal static unsafe partial class NativeMethodsLinkVisualizer
    {
        ...
        public static extern uint AUTDLinkVisualizerPhasesOf(LinkPtr visualizer, Backend backend, Directivity directivity, uint idx, double* buf);

        [DllImport(__DllName, EntryPoint = "AUTDLinkVisualizerDutiesOf", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern uint AUTDLinkVisualizerDutiesOf(LinkPtr visualizer, Backend backend, Directivity directivity, uint idx, double* buf);
        ...
        public static extern uint AUTDLinkVisualizerModulationRaw(LinkPtr visualizer, Backend backend, Directivity directivity, double* buf);

        [DllImport(__DllName, EntryPoint = "AUTDLinkVisualizerModulation", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern uint AUTDLinkVisualizerModulation(LinkPtr visualizer, Backend backend, Directivity directivity, double* buf);
        ...
        public static extern int AUTDLinkVisualizerCalcFieldOf(LinkPtr visualizer, Backend backend, Directivity directivity, double* points, uint points_len, GeometryPtr geometry, uint idx, double* buf, byte* err);

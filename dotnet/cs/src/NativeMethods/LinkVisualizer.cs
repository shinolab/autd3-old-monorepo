...
namespace AUTD3Sharp
{
    namespace NativeMethods
    {
        internal static class LinkVisualizer
        {
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern PlotRangePtr AUTDLinkVisualizerPlotRange(double xMin, double xMax, double yMin, double yMax, double zMin, double zMax, double resolution);

            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern uint AUTDLinkVisualizerPhasesOf(LinkPtr visualizer, Backend backend, Directivity directivity, uint idx, double[]? buf);

            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern uint AUTDLinkVisualizerDutiesOf(LinkPtr visualizer, Backend backend, Directivity directivity, uint idx, double[]? buf);

            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern uint AUTDLinkVisualizerModulationRaw(LinkPtr visualizer, Backend backend, Directivity directivity, double[]? buf);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern PlotConfigPtr AUTDLinkVisualizerPlotConfigWithCBarSize(PlotConfigPtr config, double cbarSize);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern PlotConfigPtr AUTDLinkVisualizerPlotConfigWithTicksStep(PlotConfigPtr config, double ticksStep);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern PyPlotConfigPtr AUTDLinkVisualizerPyPlotConfigWithTicksStep(PyPlotConfigPtr config, double ticksStep);

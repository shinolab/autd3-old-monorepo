...
namespace AUTD3Sharp
{
    internal static unsafe partial class NativeMethodsBase
    {
        ...
        public static extern ControllerBuilderPtr AUTDControllerBuilderAddDevice(ControllerBuilderPtr builder, float x, float y, float z, float rz1, float ry, float rz2);
        ...
        public static extern void AUTDModulationCacheGetBuffer(ModulationCachePtr m, float* buf);
        ...
        public static extern ModulationPtr AUTDModulationCustom(uint freq_div, float* ptr, ulong len);

        [DllImport(__DllName, EntryPoint = "AUTDModulationWithLowPass", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern ModulationPtr AUTDModulationWithLowPass(ModulationPtr m, uint n_taps, float cutoff);

        [DllImport(__DllName, EntryPoint = "AUTDModulationWithHighPass", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern ModulationPtr AUTDModulationWithHighPass(ModulationPtr m, uint n_taps, float cutoff);

        [DllImport(__DllName, EntryPoint = "AUTDModulationWithBandPass", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern ModulationPtr AUTDModulationWithBandPass(ModulationPtr m, uint n_taps, float f_low, float f_high);

        [DllImport(__DllName, EntryPoint = "AUTDModulationWithBandStop", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern ModulationPtr AUTDModulationWithBandStop(ModulationPtr m, uint n_taps, float f_low, float f_high);
        ...
        public static extern ModulationPtr AUTDModulationSineWithAmp(ModulationPtr m, float amp);
        ...
        public static extern ModulationPtr AUTDModulationSineWithOffset(ModulationPtr m, float offset);

        [DllImport(__DllName, EntryPoint = "AUTDModulationSineLegacy", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern ModulationPtr AUTDModulationSineLegacy(float freq);
        ...
        public static extern ModulationPtr AUTDModulationSineLegacyWithAmp(ModulationPtr m, float amp);
        ...
        public static extern ModulationPtr AUTDModulationSineLegacyWithOffset(ModulationPtr m, float offset);
        ...
        public static extern ModulationPtr AUTDModulationSquareWithLow(ModulationPtr m, float low);

        [DllImport(__DllName, EntryPoint = "AUTDModulationSquareWithHigh", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern ModulationPtr AUTDModulationSquareWithHigh(ModulationPtr m, float high);
        ...
        public static extern ModulationPtr AUTDModulationStaticWithAmp(ModulationPtr m, float amp);
        ...
        public static extern DatagramPtr AUTDSTMFocus(STMPropsPtr props, float* points, byte* shift, ulong size);
        ...
        public static extern STMPropsPtr AUTDSTMProps(float freq);

        [DllImport(__DllName, EntryPoint = "AUTDSTMPropsWithSamplingFreq", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern STMPropsPtr AUTDSTMPropsWithSamplingFreq(float freq);
        ...
        public static extern float AUTDSTMPropsSamplingFrequency(STMPropsPtr props, ulong size);

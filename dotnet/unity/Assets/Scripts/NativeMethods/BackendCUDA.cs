...
namespace AUTD3Sharp
{
    namespace NativeMethods
    {
        internal static class BackendCUDA
        {
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDASDP(BackendPtr backend, float[]? points, float[]? amps, ulong size);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDASDPWithAlpha(GainPtr holo, float alpha);

            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDASDPWithLambda(GainPtr holo, float lambda);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDAEVP(BackendPtr backend, float[]? points, float[]? amps, ulong size);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDAEVPWithGamma(GainPtr holo, float gamma);

            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDAGS(BackendPtr backend, float[]? points, float[]? amps, ulong size);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDAGSPAT(BackendPtr backend, float[]? points, float[]? amps, ulong size);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDANaive(BackendPtr backend, float[]? points, float[]? amps, ulong size);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDAGreedy(float[]? points, float[]? amps, ulong size);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDALM(BackendPtr backend, float[]? points, float[]? amps, ulong size);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDALMWithEps1(GainPtr holo, float eps);

            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDALMWithEps2(GainPtr holo, float eps);

            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDALMWithTau(GainPtr holo, float tau);
            ...
            [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public unsafe static extern GainPtr AUTDGainHoloCUDALMWithInitial(GainPtr holo, float[]? initialPtr, ulong len);
        }
    }

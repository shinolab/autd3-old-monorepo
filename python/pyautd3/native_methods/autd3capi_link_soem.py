...
class NativeMethods(metaclass=Singleton):
    ...
    def init_dll(self):
        ...
        self.dll.AUTDLinkSOEM.argtypes = [ctypes.POINTER(ctypes.c_void_p), ctypes.c_char_p, ctypes.c_uint16, ctypes.c_uint16, ctypes.c_bool, ctypes.c_void_p, ctypes.c_bool] 

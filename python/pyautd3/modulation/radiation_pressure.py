...
class RadiationPressure(IModulation):
    ...
    def __init__(self: "RadiationPressure", m: IModulation) -> None:
        self._m = m
...
def __with_radiation_pressure(self: IModulation) -> RadiationPressure:
    """Apply modulation to radiation pressure instead of amplitude."""
    return RadiationPressure(self)


IModulation.with_radiation_pressure = __with_radiation_pressure  # type: ignore[attr-defined]

...
class Square(IModulationWithFreqDiv):
    ...
    def with_low(self: "Square", low: float) -> "Square":
    ...
    def with_high(self: "Square", high: float) -> "Square":
    ...
    def _modulation_ptr(self: "Square") -> ModulationPtr:
        ...
        if self._freq_div is not None:
            ptr = Base().modulation_square_with_sampling_frequency_division(ptr, self._freq_div)
        return ptr

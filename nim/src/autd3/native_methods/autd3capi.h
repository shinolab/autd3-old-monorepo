...
void AUTDSetMode(void* geometry_builder, uint8 mode);
...
void AUTDGainSTM(void** out, uint16 mode);
...
bool AUTDSend(void* handle, void* header, void* body, int64 timeout_ns);
bool AUTDSendSpecial(void* handle, void* special, int64 timeout_ns);
...
void AUTDSoftwareSTM(void** out, uint8 strategy);
...
uint32 AUTDSoftwareSTMSamplingPeriod(void* stm);
void AUTDSoftwareSTMSetSamplingPeriod(void* stm, uint32 period);
void AUTDDeleteSoftwareSTM(void* stm);
void AUTDLinkDebug(void** out);
void AUTDLinkDebugLogLevel(void* debug, int32 level);
void AUTDLinkDebugLogFunc(void* debug, void* out_func, void* flush_func);
void AUTDLinkDebugTimeout(void* debug, uint64 timeout_ns);

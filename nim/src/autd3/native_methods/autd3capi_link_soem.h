...
void AUTDLinkSOEM(void** out, char* ifname, uint16 sync0_cycle, uint16 send_cycle, bool freerun, void* on_lost, bool high_precision, uint64 state_check_interval, int32 level, void* out_func, void* flush_func);

...
EXPORT_AUTD bool AUTDPointSTMAdd(void* seq, double x, double y, double z, uint8_t shift);
EXPORT_AUTD bool AUTDGainSTMAdd(void* seq, void* gain);
EXPORT_AUTD double AUTDSTMSetFrequency(void* seq, double freq);
EXPORT_AUTD double AUTDSTMFrequency(const void* seq);
EXPORT_AUTD double AUTDSTMSamplingFrequency(const void* seq);
EXPORT_AUTD uint32_t AUTDSTMSamplingFrequencyDivision(const void* seq);
EXPORT_AUTD void AUTDSTMSetSamplingFrequencyDivision(void* seq, uint32_t freq_div);
EXPORT_AUTD void AUTDDeleteSTM(const void* seq);
EXPORT_AUTD bool AUTDStop(void* handle);
EXPORT_AUTD bool AUTDSendHeader(void* handle, void* header);
EXPORT_AUTD bool AUTDSendBody(void* handle, void* body);
EXPORT_AUTD bool AUTDSendHeaderBody(void* handle, void* header, void* body);

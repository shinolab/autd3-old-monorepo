...
class CustomGain final : public autd3::Gain {
 public:
  ...
  std::vector<autd3::driver::Drive> calc(const autd3::core::Geometry& geometry) override {
    std::vector<autd3::driver::Drive> drives(geometry.num_transducers(), autd3::driver::Drive{0, 0});
...
class CustomModulation final : public autd3::Modulation {
 public:
  ...
  std::vector<autd3_float_t> calc() override { return _data; }
 ...
 private:
  std::vector<autd3_float_t> _data;
};

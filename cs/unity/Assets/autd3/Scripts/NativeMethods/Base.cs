...
namespace AUTD3Sharp.NativeMethods
{
    internal static class Base
    {
        ...
        [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)][return: MarshalAs(UnmanagedType.U1)] public static extern bool AUTDAddDevice(IntPtr handle, float x, float y, float z, float rz1, float ry, float rz2);
        [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)][return: MarshalAs(UnmanagedType.U1)] public static extern bool AUTDAddDeviceQuaternion(IntPtr handle, float x, float y, float z, float qw, float qx, float qy, float qz);
        ...
        [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern void AUTDGeometryCenterOf(IntPtr handle, int devIdx, out float x, out float y, out float z);

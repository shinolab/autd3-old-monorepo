...
namespace AUTD3Sharp.NativeMethods
{
    internal static class LinkRemoteSOEM
    {
        ...
        [DllImport(DLL, CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true, CallingConvention = CallingConvention.Cdecl)] public static extern void AUTDLinkRemoteSOEMServerIpAddr(IntPtr remoteSOEM, string serverIpAddr);
        [DllImport(DLL, CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true, CallingConvention = CallingConvention.Cdecl)] public static extern void AUTDLinkRemoteSOEMClientAmsNetId(IntPtr remoteSOEM, string clientAmsNetId);

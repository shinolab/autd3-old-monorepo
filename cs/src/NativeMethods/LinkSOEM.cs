...
namespace AUTD3Sharp.NativeMethods
{
    internal static class LinkSOEM
    {
        ...
        [DllImport(DLL, CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true, CallingConvention = CallingConvention.Cdecl)] public static extern void AUTDLinkSOEM(out IntPtr @out, string ifname, ulong bufSize, ushort sync0Cycle, ushort sendCycle, [MarshalAs(UnmanagedType.U1)] bool freerun, IntPtr onLost, byte timerStrategy, ulong stateCheckInterval, int level, IntPtr outFunc, IntPtr flushFunc);
    }
}

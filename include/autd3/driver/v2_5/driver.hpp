...
/**
 * @brief Driver for v2.5 firmware
 */
class DriverV2_5 final : public Driver {
 public:
  DriverV2_5() = default;
  ~DriverV2_5() override = default;
  DriverV2_5(const DriverV2_5& v) = default;
  DriverV2_5& operator=(const DriverV2_5& obj) = default;
  DriverV2_5(DriverV2_5&& obj) = default;
  DriverV2_5& operator=(DriverV2_5&& obj) = default;

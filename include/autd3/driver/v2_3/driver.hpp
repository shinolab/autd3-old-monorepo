...
/**
 * @brief Driver for v2.3 firmware
 */
class DriverV2_3 final : public Driver {
 public:
  DriverV2_3() = default;
  ~DriverV2_3() override = default;
  DriverV2_3(const DriverV2_3& v) = default;
  DriverV2_3& operator=(const DriverV2_3& obj) = default;
  DriverV2_3(DriverV2_3&& obj) = default;
  DriverV2_3& operator=(DriverV2_3&& obj) = default;

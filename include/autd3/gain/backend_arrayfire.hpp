...
class ArrayFireBackend : public Backend {
 public:
  ...
  void pseudo_inverse_svd(MatrixXc& src, driver::autd3_float_t alpha, MatrixXc& u, MatrixXc& s, MatrixXc& vt, MatrixXc& buf,
                          MatrixXc& dst) override = 0;
  ...
  void pow(const VectorXd& src, driver::autd3_float_t p, VectorXd& dst) override = 0;
  ...
  driver::autd3_float_t max_element(const VectorXd& src) override = 0;
  void scale(driver::autd3_float_t value, VectorXd& dst) override = 0;
  driver::autd3_float_t dot(const VectorXd& a, const VectorXd& b) override = 0;

  void add(driver::autd3_float_t alpha, const MatrixXd& a, MatrixXd& b) override = 0;
  void add(driver::autd3_float_t alpha, const VectorXd& a, VectorXd& b) override = 0;
  ...
  void mul(Transpose trans_a, Transpose trans_b, driver::autd3_float_t alpha, const MatrixXd& a, const MatrixXd& b, driver::autd3_float_t beta,
           MatrixXd& c) override = 0;
  void mul(Transpose trans_a, driver::autd3_float_t alpha, const MatrixXd& a, const VectorXd& b, driver::autd3_float_t beta,
           VectorXd& c) override = 0;
  ...
  void pseudo_inverse_svd(MatrixXd& src, driver::autd3_float_t alpha, MatrixXd& u, MatrixXd& s, MatrixXd& vt, MatrixXd& buf,
                          MatrixXd& dst) override = 0;

  static BackendPtr create(af::Backend backend = af::Backend::AF_BACKEND_DEFAULT);
};

...
autd_add_device(handle, x, y, z, rz1, ry, rz2) = ccall((:AUTDAddDevice, _dll), Bool, (Ptr{Cvoid}, Float64, Float64, Float64, Float64, Float64, Float64, ), handle, x, y, z, rz1, ry, rz2);
autd_add_device_quaternion(handle, x, y, z, qw, qx, qy, qz) = ccall((:AUTDAddDeviceQuaternion, _dll), Bool, (Ptr{Cvoid}, Float64, Float64, Float64, Float64, Float64, Float64, Float64, ), handle, x, y, z, qw, qx, qy, qz);

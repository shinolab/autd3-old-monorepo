...
autd_set_sound_speed_from_temp(cnt, temp, k, r, m) = ccall((:AUTDSetSoundSpeedFromTemp, _dll), Cvoid, (Ptr{Cvoid}, Float64, Float64, Float64, Float64, ), cnt, temp, k, r, m);
...
autd_get_firmware_info(p_firm_info_list, index, info, matches_version, is_latest) = ccall((:AUTDGetFirmwareInfo, _dll), Cvoid, (Ptr{Cvoid}, Int32, Ptr{UInt8}, Ref{Bool}, Ref{Bool}, ), p_firm_info_list, index, info, matches_version, is_latest);
...
autd_gain_stm(out) = ccall((:AUTDGainSTM, _dll), Cvoid, (Ref{Ptr{Cvoid}}, ), out);

...
autd_get_mod_delay(geometry, trans_idx) = ccall((:AUTDGetModDelay, _dll), UInt16, (Ptr{Cvoid}, Int32, ), geometry, trans_idx);
autd_set_mod_delay(geometry, trans_idx, delay) = ccall((:AUTDSetModDelay, _dll), Cvoid, (Ptr{Cvoid}, Int32, UInt16, ), geometry, trans_idx, delay);

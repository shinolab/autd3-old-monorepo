...
autd_set_mode(geometry_builder, mode) = ccall((:AUTDSetMode, _dll), Cvoid, (Ptr{Cvoid}, UInt8, ), geometry_builder, mode);
...
autd_send(handle, header, body, timeout_ns) = ccall((:AUTDSend, _dll), Bool, (Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Int64, ), handle, header, body, timeout_ns);
autd_send_special(handle, special, timeout_ns) = ccall((:AUTDSendSpecial, _dll), Bool, (Ptr{Cvoid}, Ptr{Cvoid}, Int64, ), handle, special, timeout_ns);
...
autd_software_stm(out, strategy) = ccall((:AUTDSoftwareSTM, _dll), Cvoid, (Ref{Ptr{Cvoid}}, UInt8, ), out, strategy);

...
autd_gain_transducer_test_set(gain, dev_idx, tr_idx, amp, phase) = ccall((:AUTDGainTransducerTestSet, _dll), Cvoid, (Ptr{Cvoid}, Int32, Int32, Float64, Float64, ), gain, dev_idx, tr_idx, amp, phase);
...
autd_point_stm(out, sound_speed) = ccall((:AUTDPointSTM, _dll), Cvoid, (Ref{Ptr{Cvoid}}, Float64, ), out, sound_speed);
autd_gain_stm(out, handle) = ccall((:AUTDGainSTM, _dll), Cvoid, (Ref{Ptr{Cvoid}}, Ptr{Cvoid}, ), out, handle);
autd_point_stm_add(stm, x, y, z, shift) = ccall((:AUTDPointSTMAdd, _dll), Cvoid, (Ptr{Cvoid}, Float64, Float64, Float64, UInt8, ), stm, x, y, z, shift);

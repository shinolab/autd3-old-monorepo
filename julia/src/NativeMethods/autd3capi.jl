...
autd_gain_transducer_test(gain, dev_idx, tr_idx, amp, phase) = ccall((:AUTDGainTransducerTest, _dll), Cvoid, (Ref{Ptr{Cvoid}}, Int32, Int32, Float64, Float64, ), gain, dev_idx, tr_idx, amp, phase);

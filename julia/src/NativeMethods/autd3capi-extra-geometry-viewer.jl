...
autd_extra_geometry_viewer(cnt, width, height, vsync, gpu_idx) = ccall((:AUTDExtraGeometryViewer, _dll), Bool, (Ptr{Cvoid}, Int32, Int32, Bool, Int32, ), cnt, width, height, vsync, gpu_idx);
end

...
autd_link_soem(out, ifname, sync0_cycle, send_cycle, freerun, on_lost, high_precision, state_check_interval, level, out_func, flush_func) = ccall((:AUTDLinkSOEM, _dll), Cvoid, (Ref{Ptr{Cvoid}}, Cstring, UInt16, UInt16, Bool, Ptr{Cvoid}, Bool, UInt64, Int32, Ptr{Cvoid}, Ptr{Cvoid}, ), out, ifname, sync0_cycle, send_cycle, freerun, on_lost, high_precision, state_check_interval, level, out_func, flush_func);
end

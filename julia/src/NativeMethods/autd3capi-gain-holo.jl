...
const _dll = joinpath(@__DIR__, "bin", get_lib_prefix() * "autd3capi-gain-holo" * get_lib_ext())
...
autd_gain_holo_evd(gain, backend, gamma) = ccall((:AUTDGainHoloEVD, _dll), Cvoid, (Ref{Ptr{Cvoid}}, Ptr{Cvoid}, Float64, ), gain, backend, gamma);

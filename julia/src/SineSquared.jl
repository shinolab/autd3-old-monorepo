...
mutable struct SineSquared
    _m::Modulation
    _header_ptr
    get_sampling_frequency_division
    set_sampling_frequency_division
    get_sampling_frequency
    function SineSquared(freq, amp::Float64=1.0, offset::Float64=0.5)
        chandle = Ref(Ptr{Cvoid}(0))
        autd3capi.autd_modulation_sine_squared(chandle, Int32(freq), amp, offset)

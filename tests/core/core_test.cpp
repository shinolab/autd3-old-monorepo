...
TEST(DeviceTest, to_local) {
  const autd3::core::Geometry::Device device0(0, Vector3(10, 20, 30), Quaternion::Identity());
  ASSERT_NEAR_VECTOR3(device0.to_local_position(Vector3(10, 20, 30)), Vector3::Zero(), 1e-3);

  const autd3::core::Geometry::Device device1(1, Vector3(0, 0, 0), Quaternion::Identity() * Eigen::AngleAxis(autd3::driver::pi, Vector3::UnitX()));
  ASSERT_NEAR_VECTOR3(device1.to_local_position(Vector3(10, 20, 30)), Vector3(10, -20, -30), 1e-3);

  const autd3::core::Geometry::Device device2(1, Vector3(0, 0, 0), Quaternion::Identity() * Eigen::AngleAxis(autd3::driver::pi, Vector3::UnitY()));
  ASSERT_NEAR_VECTOR3(device2.to_local_position(Vector3(10, 20, 30)), Vector3(-10, 20, -30), 1e-3);

  const autd3::core::Geometry::Device device3(1, Vector3(0, 0, 0), Quaternion::Identity() * Eigen::AngleAxis(autd3::driver::pi, Vector3::UnitZ()));
  ASSERT_NEAR_VECTOR3(device3.to_local_position(Vector3(10, 20, 30)), Vector3(-10, -20, 30), 1e-3);

  const autd3::core::Geometry::Device device4(1, Vector3(40, 60, 50),
                                              Quaternion::Identity() * Eigen::AngleAxis(autd3::driver::pi / 2, Vector3::UnitZ()));

...
TEST(DriverV2_3Driver, operation_clear_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_null_header_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_null_body_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_sync_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_modulation_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_config_silencer_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, normal_legacy_header_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_normal_legacy_body_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_normal_header_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_normal_duty_body_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_normal_phase_body_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_focus_stm_header_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_focus_stm_subsequent_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_gain_stm_legacy_header_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_gain_stm_legacy_body_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_gain_stm_normal_header_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_gain_stm_normal_phase_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_gain_stm_normal_duty_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_force_fan_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_reads_fpga_info_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_cpu_version_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_fpga_version_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();
...
TEST(DriverV2_3Driver, operation_fpga_functions_v2_3) {
  const auto driver = autd3::driver::DriverV2_3();

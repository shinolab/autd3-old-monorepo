...
void DriverV2_2::normal_duty_body(const std::vector<Drive>& drives, const std::vector<uint16_t>& cycles, TxDatagram& tx) const noexcept {
...
void DriverV2_2::normal_phase_body(const std::vector<Drive>& drives, const std::vector<uint16_t>& cycles, TxDatagram& tx) const noexcept {
...
bool DriverV2_2::gain_stm_normal_phase(const std::vector<std::vector<Drive>>& drives, const std::vector<uint16_t>& cycles, const size_t sent,
...
bool DriverV2_2::gain_stm_normal_duty(const std::vector<std::vector<Drive>>& drives, const std::vector<uint16_t>& cycles, const size_t sent,
                                      const uint32_t freq_div, const GainSTMMode mode, std::optional<uint16_t>, std::optional<uint16_t>,
                                      TxDatagram& tx) const {
  if (drives.size() > v2_2::GAIN_STM_BUF_SIZE_MAX) {
    spdlog::error("GainSTM out of buffer");

...
impl Operation for ConfigurePhaseFilterOp {
    fn pack(&mut self, device: &Device, tx: &mut [u8]) -> Result<usize, AUTDInternalError> {
        ...
        unsafe {
            ...
            dst.iter_mut()
                .zip(device.iter())
                .for_each(|(d, tr)| d.set(tr.phase_filter()));
        }
...
mod tests {
    ...
    use super::*;
    use crate::{defined::PI, geometry::tests::create_geometry};
    ...
    fn filter_phase_op() {
        ...
        geometry.devices().for_each(|dev| {
            ...
            tx.chunks(2)
                ...
                .zip(dev.iter())
                .for_each(|(d, tr)| {
                    let phase = FilterPhase::to_phase(tr.phase_filter());

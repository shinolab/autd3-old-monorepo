...
constexpr uint16_t to_le_bytes(const uint16_t v) { return v; }

constexpr uint32_t to_le_bytes(const uint32_t v) { return v; }

constexpr int64_t to_le_bytes(const int64_t v) { return v; }
